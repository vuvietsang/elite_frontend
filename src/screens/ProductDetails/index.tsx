  ...
  <div className="container-fluid py-5">
    <div className="row px-xl-5">
      <div className="col-lg-5 pb-5">
              <img className="w-100 h-100" src="src/assets/img/product-2.jpg" alt="Image" />
      </div>
    ...
    <div className="row px-xl-5">
      <div className="col">
        <div className="nav nav-tabs justify-content-center border-secondary mb-4">
          <a className="active nav-item nav-link" data-toggle="tab" href="#tab-pane-3">Reviews (0)</a>
        </div>
        <div className="tab-content">
          <div className="tab-pane show active fade" id="tab-pane-3">
            <div className="row flex justify-center">
              <div className="col-md-8">
                <h4 className="mb-4 text-lg font-bold">1 review for "Colorful Stylish Shirt"</h4>
              ...
              <div className="col-md-8">
                <h4 className="mb-10 mt-5 text-lg font-bold ">Leave a review</h4>
